...
function RegisterComponent() {
  ...
  const onUserRegister = async (userObj) => {
    console.log("onUserRegister called. userObj:", userObj);
    
    if (!userObj) {
      console.error("Critical: userObj is undefined in onUserRegister!");
      setApiError("Form data was not captured correctly. Please try again.");
      return;
    }
    ...
    try {
      ...
      // Use the centralized api instance for multipart data. Axios will automatically handle the Content-Type boundary.
      ...
      if (!err.response) {
        setApiError("Server is unreachable. Please check if the backend is running and your database is connected.");
      } else {
